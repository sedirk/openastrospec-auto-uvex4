    ...
    IProgress<ApplicationStatus>? progress) : ObservationStageRunnerBase, IObservationRunProvenanceSource
{
    ...
    internal static string StageDisplayName(ObservationStage stage) => stage switch
    {
        ...
        ObservationStage.AcquireQhyWideField => "QHY/GS350 广域取景",
        ObservationStage.CoarseCenter => "有界粗定位",
        ObservationStage.AcquireG3SlitField => "PHD2/G3 狭缝视场获取",
        ObservationStage.PlaceTargetOnSlit => "自动目标入缝",
        ObservationStage.StartGuiding => "选星、导星与稳定判定",
